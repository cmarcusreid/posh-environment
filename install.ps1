...
Import-Module "$scriptDirectory\PoshEnvironment.psm1"
...
$profileLine = "Import-Module '$scriptDirectory\PoshEnvironment.psm1'"
if(Select-String -Path $PROFILE -Pattern $profileLine -Quiet -SimpleMatch)
{
    Write-Host -ForegroundColor Green 'Found existing posh-environment import in $PROFILE.'
    Write-Host -ForegroundColor Green 'posh-environment successfully installed!'
    return
}
...
Write-Host -ForegroundColor Green "Adding posh-environment to profile."
@"

# Import posh-environment
